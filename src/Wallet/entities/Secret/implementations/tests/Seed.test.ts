...
describe('Seed', () => {
    ...
    it('New seed', async () => {
        ...
        const seed = Seed.fromString('000102030405060708090a0b0c0d0e0f')
    ...
    it('Invalid seed', async () => {
        await expect(async () => await Seed.fromString('Invalid hexadecimal')).rejects.toThrow(SeedEncodingError)
    })
})
