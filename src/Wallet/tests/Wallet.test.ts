...
describe('Wallet', () => {
    ...
    it('should create an encrypted wallet, serialize/deserialize it, and manage addresses correctly', async () => {
        ...
        const { wallet } = await initializeWallet.create({
            apiKey: '388ee8e7-019d-4136-9bf6-fc56e95919df',
        ...
        // From private key
        const wallet2 = await initializeWallet.fromPrivateKey({
            privateKey: '741745080050f2ce656aaa2a983a6b510caa706643e1ad05214feac6677ba657',
            encrypt,
        })
        await checkSerialization(wallet2)

        // From seed
        const wallet3 = await initializeWallet.fromSeed({
        ...
        // From phrase
        const wallet4 = await initializeWallet.fromPhrase({
            phrase: 'abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon abandon about',
            encrypt,
        })
